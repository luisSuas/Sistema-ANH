// src/medica/medicaHomeCoordinacion.jsx
import React, { useEffect, useMemo, useState } from 'react';
import { useNavigate, NavLink } from 'react-router-dom';
import api, { setToken } from "../servicios/Servicios";
import './MedicaHomeCoordinación.css';
...
export default function MedicaHomeCoordinacion(){
    ...
    <div className={`medica-shell social-shell ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <aside className="medica-sidebar social-sidebar">
        ...
        <div className="medica-userbox social-userbox">
          <div className="medica-userline social-userline">{user?.nombre || 'Usuario'}</div>
          <div className="medica-userline social-userline small">Coord. Área · Área: {String(user?.area ?? '-')}</div>
          <button className="link-ghost" onClick={logout}>Salir</button>
        </div>
      </aside>

      <div className="medica-main social-main">
        <header className="medica-topbar social-topbar coord-topbar" data-avoid-fab>
                        ...
                        return (
                          <tr key={c.id}>
                            ...
                            <td className="coord-actions">
                              <button className="btn-secondary" onClick={()=>navigate(`/medica/casos/${c.id}`)}>Ver</button>
