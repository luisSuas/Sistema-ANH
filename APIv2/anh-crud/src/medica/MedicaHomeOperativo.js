...
import './MedicaHomeOperativo.css';
    ...
    <div className="medica-shell">
      ...
      <aside className="medica-sidebar">
        ...
        <nav className="medica-nav">
          ...
          <NavItem to="/medica/victimas" label="Víctimas" />
        </nav>
        ...
        <div className="medica-content">
          ...
          <section className="card">
            <div className="card-header">
              <h3>Nuevo caso</h3>
              <div className="card-actions">
                <Link to="/medica/casos/nuevo" className="btn-primary">+ Nuevo caso</Link>
              </div>
            </div>
            ...
            <details className="details-quick">
              ...
              <div className="quick-body">
                ...
                <div className="muted">
                  ¿No recuerdas el ID? <Link className="link" to="/medica/victimas">Ver víctimas / copiar ID</Link>
                </div>
              </div>
            </details>
          </section>
                    ...
                    {casosFiltrados.length === 0 && (
                      <tr>
                        <td className="td-center" colSpan={6}>
                          Sin casos · <Link to="/medica/casos/nuevo" className="link">Crear el primero</Link>
                        </td>
                      </tr>
                    )}
