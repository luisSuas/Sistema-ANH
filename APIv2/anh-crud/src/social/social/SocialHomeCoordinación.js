// src/social/SocialHomeCoordinacion.jsx
import React, { useEffect, useMemo, useState } from 'react';
import { useNavigate, NavLink } from 'react-router-dom';
import api, { setToken } from "../servicios/Servicios";
import './SocialHomeCoordinación.css';
...
export default function SocialHomeCoordinacion(){
                        ...
                        return (
                          <tr key={c.id}>
                            ...
                            <td className="coord-actions">
                              <button className="btn-secondary" onClick={()=>navigate(`/social/casos/${c.id}`)}>Ver</button>
