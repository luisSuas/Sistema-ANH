...
import './SocialHomeOperativo.css';
...
function SocialHome() {
  ...
  function abrirDevolucionItem(item) {
    ...
    setNotifOpen(false);
    navigate(`/social/casos/${item.casoId}`);
  }
...
async function fetchCatalogos() {
  ...
  return (
    <div className={`social-shell ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <aside className="social-sidebar">
        <div className="sidebar-header">
          <div className="social-brand">ANH · Social</div>
          <button
        ...
        <nav className="social-nav">
          <NavItem to="/social" label="Dashboard" />
          <NavItem to="/social/victimas" label="Sobrevivientes" />
        </nav>
      ...
      <div className="social-main">
        {/* Topbar */}
        <header className="social-topbar" data-avoid-fab style={{ position: 'relative' }}>
        ...
        <div className="social-content">
            ...
            <div className="card-header">
              ...
              <div className="card-actions">
                {victimaId && (
                  <button
                    className="btn-primary"
                    onClick={() => navigate(`/social/casos/nuevo?victima_id=${victimaId}`)}
          ...
          <section className="card">
            <div className="card-header">
              <h3>Nuevo proceso</h3>
              <div className="card-actions">
                <Link to="/social/casos/nuevo" className="btn-primary">+ Nuevo proceso</Link>
              </div>
            </div>
            ...
            <details className="details-quick">
              ...
              <div className="quick-body">
                ...
                <div className="muted">
                  ¿No aparece? <Link className="link" to="/social/victimas">Ver sobrevivientes</Link>
                </div>
              </div>
            </details>
          </section>
                    ...
                    {casosFiltrados.length === 0 && (
                      <tr>
                        <td className="td-center" colSpan={7}>
                          Sin procesos · <Link to="/social/casos/nuevo" className="link">Crear el primero</Link>
                        </td>
                      </tr>
                    )}
                    {casosFiltrados.map((c) => {
                      ...
                      return (
                        <tr key={c.id}>
                          ...
                          <td>
                            <button className="btn-secondary" onClick={() => navigate(`/social/casos/${c.id}`)}>Ver detalle</button>
                          </td>
                        </tr>
                      );
                    })}
