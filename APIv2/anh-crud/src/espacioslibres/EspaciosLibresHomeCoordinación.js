// src/espacioslibres/EspaciosLibresHomeCoordinación.js
    ...
    <div className="medica-shell">
      <aside className="medica-sidebar">
        ...
        <div className="medica-userbox">
          <div className="medica-userline">{user?.nombre || 'Usuario'}</div>
          <div className="medica-userline small">Coord. Área · Área: {String(user?.area ?? '-')}</div>
                        ...
                        <tr key={c.id}>
                          ...
                          <td className="coord-actions">
                            <button
                              ...
                              onClick={()=>navigate(`/espacioslibres/casos/${c.id}`)}
                            >
                              Ver
                            </button>
                      ...
                      <tbody>
                        ...
                        {valFiltradas.map(c=>(
                          <tr key={c.id}>
                            ...
                            <td>{c.codigo || '-'}</td>
                            <td>
                              <span className="badge dot validado">
                                {norm(c.estado)==='enviado' ? 'Enviado' : 'Validado'}
                              </span>
                            </td>
