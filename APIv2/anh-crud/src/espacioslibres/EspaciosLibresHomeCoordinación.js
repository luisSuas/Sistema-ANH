// src/espacioslibres/espacioslibresHomeCoordinacion.jsx
import React, { useEffect, useMemo, useState } from 'react';
import { useNavigate, NavLink } from 'react-router-dom';
import api, { setToken } from "../servicios/Servicios";
import './EspaciosLibresHomeCoordinación.css';
...
export default function EspaciosLibresHomeCoordinacion(){
    ...
    <div className={`espacioslibres-shell social-shell ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <aside className="espacioslibres-sidebar social-sidebar">
        ...
        <div className="espacioslibres-userbox social-userbox">
          <div className="espacioslibres-userline social-userline">{user?.nombre || 'Usuario'}</div>
          <div className="espacioslibres-userline social-userline small">Coord. Área · Área: {String(user?.area ?? '-')}</div>
          <button className="link-ghost" onClick={logout}>Salir</button>
        </div>
      </aside>

      <div className="espacioslibres-main social-main">
        <header className="espacioslibres-topbar social-topbar coord-topbar" data-avoid-fab>
                        ...
                        return (
                          <tr key={c.id}>
                            ...
                            <td className="coord-actions">
                              <button className="btn-secondary" onClick={()=>navigate(`/espacioslibres/casos/${c.id}`)}>Ver</button>
