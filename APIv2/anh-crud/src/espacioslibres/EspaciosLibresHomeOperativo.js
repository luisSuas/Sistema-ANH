...
import './EspaciosLibresHomeOperativo.css';

function EspaciosLibresHome() {
  ...
  function abrirDevolucionItem(item) {
    ...
    setNotifOpen(false);
    navigate(`/espacioslibres/casos/${item.casoId}`);
  }
...
async function fetchCatalogos() {
  ...
  async function crearCasoRapido(e) {
    ...
    try {
      ...
      if (id) {
        navigate(`/espacioslibres/casos/${id}`);
      } else {
  ...
  return (
    <div className={`espacioslibres-shell social-shell ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      {/* Sidebar */}
      <aside className="espacioslibres-sidebar social-sidebar">
        <div className="sidebar-header">
          <div className="espacioslibres-brand social-brand">ANH · Espacios Libres</div>
          <button
        ...
        <nav className="espacioslibres-nav social-nav">
          <NavItem to="/espacioslibres" label="Dashboard" />
          <NavItem to="/espacioslibres/victimas" label="Sobrevivientes" />
        </nav>
        <div className="espacioslibres-userbox social-userbox">
          <div className="espacioslibres-userline social-userline">{userFromToken?.nombre || 'Usuario'}</div>
          <div className="espacioslibres-userline social-userline small">
      ...
      {/* Main */}
      <div className="espacioslibres-main social-main">
        {/* Topbar */}
        <header className="espacioslibres-topbar social-topbar" data-avoid-fab style={{ position: 'relative' }}>
          ...
          <h1>Panel del Área Espacios Libres</h1>
        ...
        <div className="espacioslibres-content social-content">
          {/* Mensaje global */}
            ...
            <div className="card-header">
              ...
              <div className="card-actions">
                {victimaId && (
                  <button
                    className="btn-primary"
                    onClick={() => navigate(`/espacioslibres/casos/nuevo?victima_id=${victimaId}`)}
          ...
          <section className="card">
            <div className="card-header">
              <h3>Nuevo proceso</h3>
              <div className="card-actions">
                <Link to="/espacioslibres/casos/nuevo" className="btn-primary">+ Nuevo proceso</Link>
              </div>
            </div>
            ...
            <details className="details-quick">
              ...
              <div className="quick-body">
                ...
                <div className="muted">
                  ¿No aparece? <Link className="link" to="/espacioslibres/victimas">Ver sobrevivientes</Link>
                </div>
              </div>
            </details>
          </section>
                    ...
                    {casosFiltrados.length === 0 && (
                      <tr>
                        <td className="td-center" colSpan={7}>
                          Sin procesos · <Link to="/espacioslibres/casos/nuevo" className="link">Crear el primero</Link>
                        </td>
                      </tr>
                    )}
                    {casosFiltrados.map((c) => {
                      ...
                      return (
                        <tr key={c.id}>
                          ...
                          <td>
                            <button className="btn-secondary" onClick={() => navigate(`/espacioslibres/casos/${c.id}`)}>Ver detalle</button>
                          </td>
                        </tr>
                      );
                    })}
...
export default EspaciosLibresHome;
