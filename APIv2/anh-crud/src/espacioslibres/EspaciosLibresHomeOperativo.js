  ...
  return (
    <div className="medica-shell">
      ...
      <aside className="medica-sidebar">
        <div className="medica-brand">ANH · Espacios Libres</div>
          ...
          <section className="card">
            ...
            <details className="details-quick">
              ...
              <div className="quick-body">
                ...
                <div className="muted">
                  ¿No recuerdas el ID? <Link className="link" to="/espacioslibres/victimas">Ver sobrevivientes / copiar ID</Link>
                </div>
              </div>
            </details>
          </section>
...
export default EspaciosLibresHomeOperativo;
