    ...
    <div className="social-main victimas-page area-main">
      <header className="social-topbar" data-avoid-fab>
        ...
        <div className="topbar-actions">
          <Link to="/psicologica" className="btn-secondary">← Volver al panel</Link>
        </div>
      </header>
            ...
            <div className="card-actions">
              {victimaId && (
                <button
                  ...
                  onClick={() => nav(`/psicologica/casos/nuevo?victima_id=${victimaId}`)}
                    ...
                    return (
                      <tr key={v.id}>
                        ...
                        <td>
                          <button
                            className="btn-secondary"
                            onClick={() => nav(`/psicologica/casos/nuevo?victima_id=${v.id}`)}
