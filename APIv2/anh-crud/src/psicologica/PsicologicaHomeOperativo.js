...
function PsicologicaHome() {
  ...
  function abrirDevolucionItem(item) {
    ...
    setNotifOpen(false);
    navigate(`/psicologica/casos/${item.casoId}`);
  }
    ...
    <div className={`psicologica-shell social-shell ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <aside className="psicologica-sidebar social-sidebar">
        ...
        <div className="psicologica-userbox social-userbox">
          <div className="psicologica-userline social-userline">{userFromToken?.nombre || 'Usuario'}</div>
          <div className="psicologica-userline social-userline small">
      ...
      <div className="psicologica-main social-main">
        {/* Topbar */}
        <header className="psicologica-topbar social-topbar" data-avoid-fab style={{ position: 'relative' }}>
          ...
          <section className="card">
            ...
            <details className="details-quick">
              ...
              <div className="quick-body">
                ...
                <div className="muted">
                  ¿No aparece? <Link className="link" to="/psicologica/victimas">Ver sobrevivientes</Link>
                </div>
              </div>
            </details>
          </section>
