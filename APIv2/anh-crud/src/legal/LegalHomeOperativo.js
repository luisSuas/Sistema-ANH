...
function LegalHome() {
  ...
  function abrirDevolucionItem(item) {
    ...
    setNotifOpen(false);
    navigate(`/legal/casos/${item.casoId}`);
  }
    ...
    <div className={`legal-shell social-shell ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <aside className="legal-sidebar social-sidebar">
        ...
        <nav className="legal-nav social-nav">
          <NavItem to="/legal" label="Dashboard" />
          <NavItem to="/legal/victimas" label="Sobrevivientes" />
        </nav>
        <div className="legal-userbox social-userbox">
          <div className="legal-userline social-userline">{userFromToken?.nombre || 'Usuario'}</div>
      ...
      <div className="legal-main social-main">
        {/* Topbar */}
        <header className="legal-topbar social-topbar" data-avoid-fab style={{ position: 'relative' }}>
        ...
        <div className="legal-content social-content">
            ...
            <div className="card-header">
              ...
              <div className="card-actions">
                {victimaId && (
                  <button
                    className="btn-primary"
                    onClick={() => navigate(`/legal/casos/nuevo?victima_id=${victimaId}`)}
          ...
          <section className="card">
            <div className="card-header">
              <h3>Nuevo proceso</h3>
              <div className="card-actions">
                <Link to="/legal/casos/nuevo" className="btn-primary">+ Nuevo proceso</Link>
              </div>
            </div>
            ...
            <details className="details-quick">
              ...
              <div className="quick-body">
                ...
                <div className="muted">
                  ¿No aparece? <Link className="link" to="/legal/victimas">Ver sobrevivientes</Link>
                </div>
              </div>
            </details>
          </section>
                    ...
                    {casosFiltrados.length === 0 && (
                      <tr>
                        <td className="td-center" colSpan={7}>
                          Sin procesos · <Link to="/legal/casos/nuevo" className="link">Crear el primero</Link>
                        </td>
                      </tr>
                    )}
                    {casosFiltrados.map((c) => {
                      ...
                      return (
                        <tr key={c.id}>
                          ...
                          <td>
                            <button className="btn-secondary" onClick={() => navigate(`/legal/casos/${c.id}`)}>Ver detalle</button>
                          </td>
                        </tr>
                      );
                    })}
