// src/legal/LegalHomeOperativo.jsx
    ...
    <div className="legal-shell">
      ...
      <aside className="legal-sidebar">
        ...
        <div className="legal-userbox">
          <div className="legal-userline">{userFromToken?.nombre || 'Usuario'}</div>
          <div className="legal-userline small">
          ...
          <section className="card">
            ...
            <details className="details-quick">
              ...
              <div className="quick-body">
                ...
                <div className="muted">
                  ¿No recuerdas el ID? <Link className="link" to="/legal/victimas">Ver sobrevivientes / copiar ID</Link>
                </div>
              </div>
            </details>
          </section>
