...
function VictimasLista() {
  ...
  // ====== FORZAR ÁREA ALBERGUE ======
  const FORCED_AREA = "albergue";
  // (Se conservan los helpers/uso de token por compatibilidad, pero NO se usan)
                ...
                return (
                  <tr key={idVictima}>
                    ...
                    <td className="acciones-cell">
                      ...
                      {/* Si existe caso (aunque esté completado), mostrar "Ver caso" */}
