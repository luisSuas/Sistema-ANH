// src/albergue/AlbergueHomeCoordinación.jsx
import React, { useEffect, useMemo, useState } from 'react';
import { useNavigate, NavLink } from 'react-router-dom';
import api, { setToken } from "../servicios/Servicios";
import './AlbergueHomeCoordinación.css';
...
export default function AlbergueHomeCoordinacion(){
  ...
  return (
    <div className="albergue-shell">
      <aside className="albergue-sidebar">
        ...
        <div className="albergue-userbox">
          <div className="albergue-userline">{user?.nombre || 'Usuario'}</div>
          <div className="albergue-userline small">Coord. Área · Área: {String(user?.area ?? '-')}</div>
          <button className="link-ghost" onClick={logout}>Salir</button>
        </div>
      </aside>

      <div className="albergue-main">
        <header className="albergue-topbar">
        ...
        <div className="albergue-content">
                      ...
                      {pendFiltradas.map(c=>(
                        <tr key={c.id}>
                          ...
                          <td className="coord-actions">
                            <button className="btn-secondary" onClick={()=>navigate(`/albergue/casos/${c.id}`)}>Ver</button>
