// src/albergue/albergueHomeCoordinacion.jsx
    ...
    <div className={`albergue-shell social-shell ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <aside className="albergue-sidebar social-sidebar">
        ...
        <div className="albergue-userbox social-userbox">
          <div className="albergue-userline social-userline">{user?.nombre || 'Usuario'}</div>
          <div className="albergue-userline social-userline small">Coord. Área · Área: {String(user?.area ?? '-')}</div>
          <button className="link-ghost" onClick={logout}>Salir</button>
        </div>
      </aside>

      <div className="albergue-main social-main">
        <header className="albergue-topbar social-topbar coord-topbar" data-avoid-fab>
